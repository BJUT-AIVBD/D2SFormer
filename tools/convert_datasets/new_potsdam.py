...
def parse_args():
    ...
    parser.add_argument('--dataset_path',
                        default='/media/bdaksh/SSD256/seg_datasets/old_potsdam',
                        help='potsdam folder path')
    parser.add_argument('--tmp_dir', help='path of the temporary directory')
    parser.add_argument('-o', '--out_dir',
                        default='/media/bdaksh/SSD256/seg_datasets/123', help='output path')
    parser.add_argument(
        '--clip_size',
        type=int,
...
def main():
    ...
    for dir in os.listdir(dataset_path):
        tmp_dir = os.path.join(dataset_path, dir)
        if dir=='images':
            src_path_list = glob.glob(os.path.join(tmp_dir, '*.tif'))
        else:
            src_path_list = glob.glob(os.path.join(tmp_dir, '*.png'))
        if not len(src_path_list):
            ...
            if dir == 'images':
                ...
                src_path_list = glob.glob(os.path.join(sub_tmp_dir, '*.png'))
